...
app.include_router(voice_routes.router, prefix=settings.api_prefix, tags=["voice"])
app.include_router(debug_routes.router, prefix=settings.api_prefix, tags=["debug"])
